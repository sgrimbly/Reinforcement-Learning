# Following code came from tutorial linked below.
...
def main():
    ...
    # Use tensorboard command below to see training stats
    # tensorboard --logdir log_dir(the path of your Tensorflow summary writer).